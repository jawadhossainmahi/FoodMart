...
import NewBrandSlider from '../layouts/NewBrandSlider';
import TrendingProduct from '../layouts/product/TrendingProduct';
import Ads from '../layouts/ads/Ads';
import ProductSlider from '../layouts/product/ProductSlider';
...
function Home() {
    return (
        <>
            ...
            <ProductSlider title="Most popular products" />
            <ProductSlider title="Just arrived" />
            ...
            <section className="py-5 my-5">
                <div className="container-fluid">
                    ...
                    <div className="bg-warning py-5 rounded-5"
                        style={{ background: `url(${BgPattern2}) no-repeat` }}
                    >
                        <div className="container">
                            <div className="row">
                                <div className="col-md-4">
                                    <img src={Phone} alt="phone" className="image-float img-fluid" />
                                </div>
            ...
            <section className="py-5">
                <div className="container-fluid">
                    ...
                    <Link to="#" className="btn btn-warning me-2 mb-2">Angie’s Boomchickapop Corn</Link>
                    <Link to="#" className="btn btn-warning me-2 mb-2">Salty kettle Corn</Link>
                    <Link to="#" className="btn btn-warning me-2 mb-2">Chobani Greek Yogurt</Link>
                    <Link to="#" className="btn btn-warning me-2 mb-2">Sweet Vanilla Yogurt</Link>
                    <Link to="#" className="btn btn-warning me-2 mb-2">Foster Farms Takeout Crispy wings</Link>
                    <Link to="#" className="btn btn-warning me-2 mb-2">Warrior Blend Organic</Link>
                ...
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <div className="col-md-6 credit-link text-start text-md-end">
                            <p>Free HTML Template by <Link to="https://templatesjungle.com/">TemplatesJungle</Link> Distributed by <Link to="https://themewagon">ThemeWagon</Link></p>
                        </div>
                    </div>
                </div>
            </div>
